    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <button type="button" class="btn btn-primary float-right" id="btnAbrirAnticipo">
                    Ingresar Anticipo
                </button>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="cuenta_bancaria" name="cuenta_bancaria" class="form-control"
                                        ...
                                        <option value="{{ $pago->id }}">{{ $pago->Bancos->nombre }} -
                                            {{ $pago->nombre_cuenta }} - {{ $pago->numero_cuenta }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
...
<script>
    document.getElementById('btnAbrirAnticipo').addEventListener('click', function(e) {
        e.preventDefault();
        console.log('Botón de anticipo clickeado');
